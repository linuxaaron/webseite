...
export function CuteFooterCat() {
  ...
  useEffect(() => {
    ...
    const move = (event: PointerEvent) => {
      ...
      const b = bounds();
      const inside = event.clientX >= b.rect.left && event.clientX <= b.rect.right && event.clientY >= b.rect.top && event.clientY <= b.rect.bottom;
    ...
    const leave = () => { state.current.pointerInside = false; };
    size();
    home();
